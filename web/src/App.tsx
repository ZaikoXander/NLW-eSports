    ...
    <div className="max-w-[1344px] mx-auto flex flex-col items-center my-20">
      ...
      <Dialog.Root>
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content
            className="
              fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg
            ...
            <form className="mt-8 flex flex-col gap-4">
              ...
              <footer className="mt-4 flex justify-end gap-4">
                ...
                <button
                  type="submit"
                  className="
                    bg-violet-500 px-5 h-12 rounded-md font-semibold flex items-center gap-3
                    hover:bg-violet-600
                  "
                >
